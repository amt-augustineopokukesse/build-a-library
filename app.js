...
class Media {
    ...
    toggleCheckOutStatus() {
      this._isCheckedOut = !this._CheckedOut;
    }
  ...
  console.log(`The average rating for this book is ${historyOfEverything.getAverageRating()}`);
  ...
  console.log(`The average rating for this movie is ${speed.getAverageRating()}`);
